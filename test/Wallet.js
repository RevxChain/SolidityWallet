...
describe("Wallet", function () {
  ...
  describe("Deployment", function () {
    ...
    it("Should set the right fee value storage address", async function () {
      ...
      expect(await wallet.feeValueStorage()).to.equal(feeValueStorage.address);
    });
    ...
    it("Should deploy reverted by wrong fee recevier address", async function () {
      ...
      await expect(Wallet.deploy(owner.address, feeValueStorage.address, feeValueStorage.address)).to.be.revertedWith(
